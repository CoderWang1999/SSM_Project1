        ...
        $.ajax({
            ...
            success: function (data) {
                for (let i = 0; i < data.length; i++) {
                    $("#address").append("<option value=" + data[i].cityname + ">" + data[i].cityname + "</option>");
                }
            }
        });
    </script>
...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/user/update" method="post">
        ...
        <div class="form-group">
            <label>性别：</label>
            <input type="radio" name="gender" ${user.gender==1?"checked":""} value="1"/>男
            <input type="radio" name="gender" ${user.gender==0?"checked":""} value="0"/>女
